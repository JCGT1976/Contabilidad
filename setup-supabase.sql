...
-- =====================================================================
-- 7. PÓLIZAS CONTABLES (Ingresos, Egresos, Diario)
-- =====================================================================
...
UNION ALL SELECT 'cont_polizas', COUNT(*) FROM cont_polizas
UNION ALL SELECT 'cont_polizas_detalles', COUNT(*) FROM cont_polizas_detalles;
